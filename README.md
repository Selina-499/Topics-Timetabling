...
This project investigates the university timetabling problem through three distinct computational modelling approaches:
...
All three models operate on the same four pre-processed CSV datasets as input. The notebook `main.ipynb` serves exclusively as a data preprocessing pipeline and does not need to be executed in order to run the optimisation models.
